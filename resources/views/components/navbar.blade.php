<nav class="bg-gray-200 border-gray-200 dark:bg-gray-900">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <button id="theme-toggle" type="button"
            class=" bg-gray-300 text-gray-500 dark:text-gray-400 hover:bg-slate-600 dark:hover:bg-white focus:outline-none dark:bg-slate-600 rounded-lg text-sm p-2.5">
